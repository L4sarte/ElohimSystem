...
import { ArrowLeft, Settings, ShieldAlert, Sliders, Construction, Sparkles } from 'lucide-react';
      ...
      <main className="flex-1 container mx-auto px-4 py-8 sm:px-6 max-w-7xl space-y-6">
        ...
        <div className="bg-[#13261E] p-6 rounded-2xl border border-[#1B362A] shadow-xl">
          ...
          <p className="text-xs text-zinc-400 mt-1 max-w-xl">
            Ajustes generales del ERP, parámetros comerciales y preferencias.
          </p>
        </div>
        ...
        <Card className="border border-[#1B362A] bg-[#13261E]/90 rounded-2xl p-12 text-center shadow-xl space-y-4">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-zinc-800 text-zinc-300 border border-[#1B362A] shadow-lg">
            <Sliders className="h-8 w-8 text-[#D0A96B]" />
          </div>
          <div>
            <h3 className="text-lg font-bold text-white font-serif">Panel de Configuración Global en Desarrollo</h3>
            <p className="text-xs text-zinc-400 max-w-md mx-auto mt-1">
              Aquí podrás personalizar datos fiscales de la perfumería, integraciones de pago, API keys de cotizaciones y preferencias del sistema.
            </p>
          </div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#08130E] border border-[#1B362A] text-[11px] font-mono text-[#D0A96B]">
            <Construction className="h-3.5 w-3.5" /> Preferencias Bimonetarias & Webhooks
          </div>
        </Card>
