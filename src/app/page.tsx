          ...
          <div className="space-y-6">
            ...
            {loadingStats ? (
              ...
              <>
                ...
                {/* BARRA DE ACCESOS RÁPIDOS MÓDULOS */}
                <div className="flex flex-wrap items-center gap-3 pt-6 border-t border-[#1B362A]">
                  <span className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest mr-2">Accesos:</span>
                  <Link href="/productos">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer border-[#1B362A] bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <ShoppingBag className="mr-1.5 h-3.5 w-3.5 text-zinc-400" /> Catálogo
                    </Button>
                  </Link>
                  <Link href="/admin/inventario/ajustes">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer text-amber-400 border-amber-900/40 bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <AlertTriangle className="mr-1.5 h-3.5 w-3.5" /> Mermas & Ajustes
                    </Button>
                  </Link>
                  <Link href="/catalogo" target="_blank">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer text-emerald-400 border-emerald-900/40 bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <ExternalLink className="mr-1.5 h-3.5 w-3.5" /> Tienda B2C (Publica)
                    </Button>
                  </Link>
                  <Link href="/pos">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer border-[#1B362A] bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <ShoppingCart className="mr-1.5 h-3.5 w-3.5 text-emerald-400" /> Punto de Venta (POS)
                    </Button>
                  </Link>
                  <Link href="/clientes">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer border-[#1B362A] bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <Users className="mr-1.5 h-3.5 w-3.5 text-zinc-400" /> Clientes (CRM)
                    </Button>
                  </Link>
                  <Link href="/cobranzas">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer text-amber-400 border-amber-900/40 bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <CreditCard className="mr-1.5 h-3.5 w-3.5" /> Cobranzas / Fiados
                    </Button>
                  </Link>
                  <Link href="/auditoria/ventas">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer text-[#D0A96B] border-[#1B362A] bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <Printer className="mr-1.5 h-3.5 w-3.5" /> Historial Ventas
                    </Button>
                  </Link>
                  <Link href="/compras">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer text-emerald-400 border-emerald-900/40 bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <PackagePlus className="mr-1.5 h-3.5 w-3.5" /> Compras B2B
                    </Button>
                  </Link>
                  <Link href="/config/pagos">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer text-[#D0A96B] border-[#1B362A] bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <CreditCard className="mr-1.5 h-3.5 w-3.5" /> Cuotas & Recargos
                    </Button>
                  </Link>
                  <Link href="/admin/gastos">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer text-rose-400 border-rose-900/40 bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <FileText className="mr-1.5 h-3.5 w-3.5" /> Gastos OPEX
                    </Button>
                  </Link>
                  <Link href="/admin/reportes">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer text-indigo-400 border-indigo-900/40 bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <Activity className="mr-1.5 h-3.5 w-3.5" /> Reportes Financieros
                    </Button>
                  </Link>
                  <Link href="/auditoria">
                    <Button variant="outline" size="sm" className="h-8 text-xs cursor-pointer border-[#1B362A] bg-[#13261E]/60 hover:bg-zinc-800 transition-all hover:scale-105">
                      <AuditIcon className="mr-1.5 h-3.5 w-3.5 text-zinc-400" /> Visor Auditoría
                    </Button>
                  </Link>
                </div>
              </>
